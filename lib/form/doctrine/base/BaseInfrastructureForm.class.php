...
/**
 * Infrastructure form base class.
 *
 * @method Infrastructure getObject() Returns the current form's model object
 *
 * @package    rentman
 * @subpackage form
 ...
 */
abstract class BaseInfrastructureForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('infrastructure[%s]');
