...
/**
 * Objectunit filter form base class.
 *
 * @package    rentman
 * @subpackage filter
 ...
 */
abstract class BaseObjectunitFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('objectunit_filters[%s]');
