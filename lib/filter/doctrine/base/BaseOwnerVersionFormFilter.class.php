...
/**
 * OwnerVersion filter form base class.
 *
 * @package    rentman
 * @subpackage filter
 ...
 */
abstract class BaseOwnerVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('owner_version_filters[%s]');
