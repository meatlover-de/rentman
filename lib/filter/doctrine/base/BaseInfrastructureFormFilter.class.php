...
/**
 * Infrastructure filter form base class.
 *
 * @package    rentman
 * @subpackage filter
 ...
 */
abstract class BaseInfrastructureFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('infrastructure_filters[%s]');
